...
//para hacer un filtro de busqueda añadiremos el implemento Filterable
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull NewsViewHolder newsViewHolder, int position) {
        ...
        newsViewHolder.img_user.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_transition));
        ...
        newsViewHolder.container.setAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_scale));
    ...
    public class NewsViewHolder extends RecyclerView.ViewHolder {
        ...
        public NewsViewHolder(@NonNull View itemView) {
            ...
            tv_title = itemView.findViewById(R.id.txvTitle);
            tv_content = itemView.findViewById(R.id.txv_content);
            tv_date = itemView.findViewById(R.id.txv_date);
            img_user = itemView.findViewById(R.id.imgUser);

            //animacion
            container = itemView.findViewById(R.id.action_containeranim);
        ...
        //method para el dark mode
        private void setDarkmode(){

            container.setBackgroundResource(R.drawable.card_gb_dark);
